...
class VAPT_Polylang {
    ...
    public function maybe_auto_translate($post_id, $post, $update) {
        ...
        if (!get_option('vapt_auto_translate', false)) {
            return;
        }
    ...
    public function translate_post($post_id, $target_languages = array()) {
        ...
        if (!$source_language) {
            return new WP_Error('no_source_language', __('Please set a language for this post first', 'vaalue-ai-polylang-translator'));
        }
